    ...
    subsections: [
      {
        ...
        color: '#8B5CF6',
        items: [
          { key: 'boite',  label: 'Boites',       hint: '600 × 800 px', ratio: '3:4', format: 'WebP', maxKb: 200 },
          { key: 'sacs',   label: 'Sacs',          hint: '600 × 800 px', ratio: '3:4', format: 'WebP', maxKb: 200 },
          { key: 'carte',  label: 'Cartes',         hint: '600 × 800 px', ratio: '3:4', format: 'WebP', maxKb: 200 },
          { key: 'papier', label: 'Papier',         hint: '600 × 800 px', ratio: '3:4', format: 'WebP', maxKb: 200 },
        ],
      },
      {
        label: 'Desktop (PC)',
